...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Estándares de codificación}: el código debe ajustarse a las normas de codificación acordadas. Estas hacen que el código sea consistente y fácil de leer y refactorizar para todo el equipo. Un código con el mismo aspecto o que sigue unas normas fomenta la propiedad colectiva.
...
En el siguiente Diagrama de Gantt (Figura \ref{fig:gantt_real}) se presenta la planificación real del proyecto:
    ...
    \begin{figure}[h!]
        ...
        \caption{Diagrama de Gantt sobre la planificación temporal real. Las `R' indican las reuniones con la tutora.}
...
\begin{itemize}
    ...
    \item \textbf{Umbrello}: herramienta que combina funciones de modelado y generación de código para el lenguaje unificado de modelado (UML). Usado para la elaboración del diagrama de clases.
...
\begin{equation*}
    \textit{Coste total recursos humanos} = 522 \textit{horas} * 13,46\EUR{}/hora = 7026,12 \EUR{}
\end{equation*}
...
\midrule
                                        % &                 \\\hline
\textbf{Costes de recursos humanos}     && \textbf{7026,12 €} \\
\quad Trabajo autónomo                        && 7026,12 €          \\
\midrule
\textbf{Costes de recursos materiales}  && \textbf{491,89 €} \\
\quad Portátil personal                       && 312,2 €            \\ %Esto para darle un tabulado al elemento
\quad Pantalla de apoyo                       && 179,69 €             \\ 
\midrule
\textbf{Costes de recursos software}    && \textbf{0,00 €}    \\
                                        % & \multicolumn{1}{l}{}    \\
\quad Windows 10                              && 0,00 €             \\
\quad Visual Studio C++                       && 0,00 €             \\
\quad OpenBabel                               && 0,00 €             \\
\quad CMake                                   && 0,00 €             \\
\quad Git                                     && 0,00 €             \\
\quad GitHub                                  && 0,00 €             \\
\quad Google Colab                            && 0,00 €             \\
\quad Zotero                                  && 0,00 €             \\
\quad Google Meet                             && 0,00 €             \\
\quad Google Drive Sync                       && 0,00 €             \\
\quad Overleaf                                && 0,00 €             \\
\quad Scopus                                  && 0,00 €             \\
\quad Clockify                                && 0,00 €             \\
\quad Draw.io                                 && 0,00 €             \\
\quad Correo UGR                              && 0,00 €             \\
\quad Microsoft Word                          && 0,00 €             \\
\quad Microsoft Excel                         && 0,00 €             \\
\quad Visual Studio Code y LaTeX              && 0,00 €             \\
\midrule
\textbf{Costes adicionales}             && \textbf{219,58 €}  \\
                                        % & \multicolumn{1}{l}{}                   \\
\quad Internet                                && 40€ x 5 meses = 200€           \\
\quad Factura de la luz                       && 19,58 €            \\
                                        % & \multicolumn{1}{l}{}                   \\
\midrule
  &   \multicolumn{1}{r}{\textbf{Total:}} & \textbf{7737,59 €} \\
\bottomrule
...
\begin{figure}
    \centering
    \includegraphics[scale=0.42]{imagenes/planificacion/matriz_riesgos.png}
